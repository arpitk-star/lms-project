...
const EditUser = ({ classes, names, emails, phoneNumbers, id }) => {
  ...
  const handleImage = (e) => {
    ...
    formData.append("upload_preset","695127721748131" );
    formData.append("cloud_name", "dfznq03gd");
    let imageUrl;

    fetch("CLOUDINARY_URL=cloudinary://695127721748131:h8K-R92GBXMnuBTEer7dlTRtlg8@dfznq03gd", {
      method: "post",
      body: formData,
    })
      .then((res) => res.json())
